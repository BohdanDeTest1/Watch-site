...
document.addEventListener("DOMContentLoaded", function () {
    ...
    // Открытие/закрытие меню браслета
    const braceletToggle = document.getElementById("braceletToggle");
    const braceletOptions = document.getElementById("braceletOptions");

    braceletToggle.addEventListener("click", () => {
        braceletOptions.style.display = braceletOptions.style.display === "none" ? "flex" : "none";
    });
